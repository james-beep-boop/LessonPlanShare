...
<head>
    ...
    <title>{{ $title ?? 'ARES Education — Lesson Plan Archive' }}</title>
                ...
                <div class="flex items-center pt-1">
                    ...
                    @else
                        <button
                            ...
                            class="text-sm font-medium text-gray-900 hover:text-gray-600 cursor-pointer">
                            Sign In
                        </button>
                    @endauth
                </div>
